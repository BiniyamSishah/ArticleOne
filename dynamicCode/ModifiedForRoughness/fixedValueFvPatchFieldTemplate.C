...
//{{{ begin codeInclude
#line 36 "/d1/home/bini/OpenFOAM/run/ripple/Resolved/paper/Ap3dp2T7/caseModified/0/omega.boundaryField.bottomWall"
#include "fvCFD.H"
                #include "cmath"
                #include "iostream"
//}}} end codeInclude
...
{
    // dynamicCode:
    // SHA1 = caa4008e3650da8a8e988b7238fc5a4c196658f3
    //
    // unique function name that can be checked if the correct library version
    // has been loaded
    void ModifiedForRoughness_caa4008e3650da8a8e988b7238fc5a4c196658f3(bool load)
    {
        if (load)
        {
...
const char* const ModifiedForRoughnessFixedValueFvPatchScalarField::SHA1sum =
    "caa4008e3650da8a8e988b7238fc5a4c196658f3";
    ...
    fixedValueFvPatchField<scalar>(p, iF)
{
    if (false)
    {
        Info<<"construct ModifiedForRoughness sha1: caa4008e3650da8a8e988b7238fc5a4c196658f3"
...
~ModifiedForRoughnessFixedValueFvPatchScalarField()
{
    if (false)
    {
        Info<<"destroy ModifiedForRoughness sha1: caa4008e3650da8a8e988b7238fc5a4c196658f3\n";
    }
}
...
void ModifiedForRoughnessFixedValueFvPatchScalarField::updateCoeffs()
{
    ...
    if (false)
    {
        Info<<"updateCoeffs ModifiedForRoughness sha1: caa4008e3650da8a8e988b7238fc5a4c196658f3\n";
    }

//{{{ begin code
    #line 56 "/d1/home/bini/OpenFOAM/run/ripple/Resolved/paper/Ap3dp2T7/caseModified/0/omega.boundaryField.bottomWall"
const fvPatch& boundaryPatch = patch();                // give access to boundary mesh patch mesh
            ...
            scalar Zr = 0.0004;                                   // roughness to be incorporated 
